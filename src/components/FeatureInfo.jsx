...
const FeatureInfo = () => {
    return (
        <div className='m-5 flex flex-col gap-2 md:flex-row 
                        justify-around items-center overflow-auto'>
            <div className="flex-[1] flex-col gap-2 bg-gray-200  m-2 p-5 rounded-lg cursor-pointer shadow-lg shadow-gray-800">
